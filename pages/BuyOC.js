...
let BuyOC = function () {
   ...
   let elm4 = element(by.cssContainingText('.upcoming-pro-left', 'Lakin Throughway, West Emory, 692 sqft, Land'));
   let elm5 = element(by.cssContainingText('.bid-header-outer', 'Property ID: 42168'));
   ...
   let city = element(by.cssContainingText('.ng-placeholder','City'));
   ...
   this.openPropertNP = function () {
      ...
      browser.getAllWindowHandles().then(function (handles) {
         browser.switchTo().window(handles[1]).then(function () {
            ...
            browser.wait(EC.elementToBeClickable(BidNow_btn), 5000);
   ...
   this.viewAll = function () {
      ...
      browser.executeScript('window.scrollTo(0,400)').then(function () {
         browser.wait(EC.elementToBeClickable(elm4), 5000);
         expect(elm4.isPresent()).toBe(true)
      });
      browser.sleep(5000);
   };
